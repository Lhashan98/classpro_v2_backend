...
{
    var cordinators = await userService.getDataFromDBService();
    res.send({ "status": true, "data": adddetails });
}
...
module.exports = { getDataConntrollerfn, createUserControllerFn,updateUserController };
